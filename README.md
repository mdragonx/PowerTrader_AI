...
If you have any crypto holdings in Bitso currently, either transfer them out of your Bitso account or sell them to the quote currency BEFORE going through this setup process!
...
## Step 5 — Set your folder, coins, and Bitso keys (inside the Hub)
...
- **While you are still in Settings**, click **Bitso API Setup** and do this:

1. Create API keys in your Bitso account (API keys page).
2. Paste the **API Key** and **API Secret** into the wizard.
3. Click **Save**.
